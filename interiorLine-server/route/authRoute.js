...
router.post('/login', bruteForceProtection, logActivity("Login Attempt"), loginRequest);
router.post('/verify-otp', bruteForceProtection, checkGlobalLocks, logActivity("OTP Verification"), verifyOtp);
